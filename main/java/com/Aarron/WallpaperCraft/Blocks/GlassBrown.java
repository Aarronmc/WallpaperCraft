...
public class GlassBrown extends BlockBreakable {
...
public IIcon[] icons = new IIcon[15];
	...
	public GlassBrown(String unlocalizedName, Material material) {
		super(unlocalizedName, material.glass, false);
		this.setBlockName("GlassBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:GlassBrown-" + i);
		}
}
