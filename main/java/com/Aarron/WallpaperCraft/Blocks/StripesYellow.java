...
public class StripesYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesYellow-" + i);
		}
}
