...
public class StripesPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesPurple-" + i);
		}
}
