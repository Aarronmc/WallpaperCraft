...
public class FloralBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public FloralBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralBrown-" + i);
		}
}
