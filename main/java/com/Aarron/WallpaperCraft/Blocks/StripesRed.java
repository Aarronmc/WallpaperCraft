...
public class StripesRed extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesRed-" + i);
		}
}
