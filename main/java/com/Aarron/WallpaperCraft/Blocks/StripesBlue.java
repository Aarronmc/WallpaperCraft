...
public class StripesBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesBlue-" + i);
		}
}
