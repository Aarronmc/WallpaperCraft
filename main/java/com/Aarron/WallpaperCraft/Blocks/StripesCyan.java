...
public class StripesCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public StripesCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesCyan-" + i);
		}
}
