...
public class StripesBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesBrown-" + i);
		}
}
