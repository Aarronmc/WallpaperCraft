...
public class ClayRed extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayRed-" + i);
		}
}
