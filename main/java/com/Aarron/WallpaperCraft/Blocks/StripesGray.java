...
public class StripesGray extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesGray-" + i);
		}
}
