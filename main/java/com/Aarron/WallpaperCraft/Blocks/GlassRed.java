...
public class GlassRed extends BlockBreakable {
...
public IIcon[] icons = new IIcon[15];
	...
	public GlassRed(String unlocalizedName, Material material) {
		super(unlocalizedName, material.glass, false);
		this.setBlockName("GlassRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:GlassRed-" + i);
		}
}
