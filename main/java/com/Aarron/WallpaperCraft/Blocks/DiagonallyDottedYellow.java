...
public class DiagonallyDottedYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedYellow-" + i);
		}
}
