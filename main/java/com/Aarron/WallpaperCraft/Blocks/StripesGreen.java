...
public class StripesGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public StripesGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripesGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripesGreen-" + i);
		}
}
