...
public class CheckeredCarpetRed extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetRed-" + i);
		}
}
