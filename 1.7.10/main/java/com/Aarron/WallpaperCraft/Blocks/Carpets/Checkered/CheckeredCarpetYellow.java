...
public class CheckeredCarpetYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetYellow-" + i);
		}
}
