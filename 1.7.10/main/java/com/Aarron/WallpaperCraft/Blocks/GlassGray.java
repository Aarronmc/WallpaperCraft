...
public class GlassGray extends BlockBreakable {
...
public IIcon[] icons = new IIcon[15];
	...
	public GlassGray(String unlocalizedName, Material material) {
		super(unlocalizedName, material.glass, false);
		this.setBlockName("GlassGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:GlassGray-" + i);
		}
}
