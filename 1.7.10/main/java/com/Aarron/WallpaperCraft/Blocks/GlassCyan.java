...
public class GlassCyan extends BlockBreakable {
...
public IIcon[] icons = new IIcon[15];
	...
	public GlassCyan(String unlocalizedName, Material material) {
		super(unlocalizedName, material.glass, false);
		this.setBlockName("GlassCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:GlassCyan-" + i);
		}
}
