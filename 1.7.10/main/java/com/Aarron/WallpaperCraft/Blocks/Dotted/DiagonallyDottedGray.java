...
public class DiagonallyDottedGray extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedGray-" + i);
		}
}
