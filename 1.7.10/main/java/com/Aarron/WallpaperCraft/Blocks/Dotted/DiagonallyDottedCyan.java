...
public IIcon[] icons = new IIcon[10];
	...
	public DiagonallyDottedCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedCyan-" + i);
		}
}
