...
public class DottedRugCyan extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetCyan-" + i);
		}
}
