...
public class SolidGreenBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidGreenBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidGreen-" + i);
		}
}
