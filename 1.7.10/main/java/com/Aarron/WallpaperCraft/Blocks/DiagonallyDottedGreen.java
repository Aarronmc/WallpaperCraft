...
public class DiagonallyDottedGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedGreen-" + i);
		}
}
