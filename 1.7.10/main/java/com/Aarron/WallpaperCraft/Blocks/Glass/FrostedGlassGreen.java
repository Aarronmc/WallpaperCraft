...
public class FrostedGlassGreen extends BlockBreakable {
...
public IIcon[] icons = new IIcon[15];
	...
	public FrostedGlassGreen(String unlocalizedName, Material material) {
		super(unlocalizedName, material.glass, false);
		this.setBlockName("FrostedGlassGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FrostedGlassGreen-" + i);
		}
}
