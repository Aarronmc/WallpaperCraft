...
public class BrickRed extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickRed-" + i);
		}
}
