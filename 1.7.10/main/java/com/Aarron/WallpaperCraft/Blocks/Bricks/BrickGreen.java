...
public class BrickGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickGreen-" + i);
		}
}
