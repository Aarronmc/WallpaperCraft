package com.Aarron.WallpaperCraft.Blocks.Striped;
...
public class StripedPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedPurple-" + i);
		}
}
