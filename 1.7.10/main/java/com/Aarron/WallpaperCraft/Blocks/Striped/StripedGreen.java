...
public class StripedGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedGreen-" + i);
		}
}
