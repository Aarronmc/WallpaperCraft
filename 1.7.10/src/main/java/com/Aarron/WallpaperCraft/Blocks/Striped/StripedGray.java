...
public class StripedGray extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedGray-" + i);
		}
}
