...
public class CheckeredCarpetBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetBlue-" + i);
		}
}
