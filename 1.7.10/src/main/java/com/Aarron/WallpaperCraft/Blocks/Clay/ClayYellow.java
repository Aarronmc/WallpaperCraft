...
public class ClayYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayYellow-" + i);
		}
}
