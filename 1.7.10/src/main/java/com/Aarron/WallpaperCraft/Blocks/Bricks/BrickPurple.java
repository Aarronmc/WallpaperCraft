...
public class BrickPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickPurple-" + i);
		}
}
