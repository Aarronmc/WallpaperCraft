...
public class CheckeredCarpetGray extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetGray-" + i);
		}
}
