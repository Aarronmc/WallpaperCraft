...
public class DottedRugBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetBlue-" + i);
		}
}
