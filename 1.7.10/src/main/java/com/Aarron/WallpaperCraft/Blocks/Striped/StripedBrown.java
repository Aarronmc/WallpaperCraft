...
public class StripedBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedBrown-" + i);
		}
}
