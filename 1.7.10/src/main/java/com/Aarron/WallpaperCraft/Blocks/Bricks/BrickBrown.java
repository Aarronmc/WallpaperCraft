...
public class BrickBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickBrown-" + i);
		}
}
