...
public class ClayPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayPurple-" + i);
		}
}
