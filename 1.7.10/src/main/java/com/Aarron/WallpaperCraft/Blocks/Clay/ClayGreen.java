...
public class ClayGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayGreen-" + i);
		}
}
