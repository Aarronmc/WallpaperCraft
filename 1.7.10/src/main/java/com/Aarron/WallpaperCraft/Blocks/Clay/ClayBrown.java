...
public class ClayBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayBrown-" + i);
		}
}
