...
public class StripedRed extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedRed-" + i);
		}
}
