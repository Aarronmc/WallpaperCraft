...
public class DottedRugBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetBrown-" + i);
		}
}
