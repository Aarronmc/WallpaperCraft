...
public class SolidCyanBlocks extends Block {

public IIcon[] icons = new IIcon[10];

	public SolidCyanBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidCyan-" + i);
		}
}
