...
public class DottedRugGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetGreen-" + i);
		}
}
