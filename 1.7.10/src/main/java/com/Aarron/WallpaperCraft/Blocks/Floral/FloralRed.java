...
public class FloralRed extends Block {

public IIcon[] icons = new IIcon[15];

	public FloralRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralRed-" + i);
		}
}
