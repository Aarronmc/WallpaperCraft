...
public class BrickYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickYellow-" + i);
		}
}
