...
public class SolidBrownBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidBrownBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidBrown-" + i);
		}
}
