package com.Aarron.WallpaperCraft.Blocks.Rugs.Dotted;
...
public class DottedRugPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetPurple-" + i);
		}
}
