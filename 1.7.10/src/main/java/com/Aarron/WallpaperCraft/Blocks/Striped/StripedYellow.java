...
public class StripedYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public StripedYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedYellow-" + i);
		}
}
