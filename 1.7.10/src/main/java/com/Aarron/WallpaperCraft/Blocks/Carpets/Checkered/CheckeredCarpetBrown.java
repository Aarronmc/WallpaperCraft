...
public class CheckeredCarpetBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetBrown-" + i);
		}
}
