...
public class SolidRedBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidRedBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidRed-" + i);
		}
}
