package com.Aarron.WallpaperCraft.Blocks.Carpets.Checkered;
...
public class CheckeredCarpetPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetPurple-" + i);
		}
}
