...
public class DottedRugRed extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetRed-" + i);
		}
}
