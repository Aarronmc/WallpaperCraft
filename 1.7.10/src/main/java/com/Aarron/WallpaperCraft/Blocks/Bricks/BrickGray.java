...
public class BrickGray extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickGray-" + i);
		}
}
