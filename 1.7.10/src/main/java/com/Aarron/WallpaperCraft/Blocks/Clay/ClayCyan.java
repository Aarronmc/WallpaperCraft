...
public class ClayCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public ClayCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayCyan-" + i);
		}
}
