...
public class FloralPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public FloralPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralPurple-" + i);
		}
}
