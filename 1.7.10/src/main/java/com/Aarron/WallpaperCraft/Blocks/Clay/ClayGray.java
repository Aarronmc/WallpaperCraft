...
public class ClayGray extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayGray-" + i);
		}
}
