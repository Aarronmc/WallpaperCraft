package com.Aarron.WallpaperCraft.Blocks.Rugs.Checkered;
...
public class CheckeredRugPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredRugPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredRugPurple");
