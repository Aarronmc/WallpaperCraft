...
public class FloralCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public FloralCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralCyan-" + i);
		}
}
