...
public class StripedCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public StripedCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StripedCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:StripedCyan-" + i);
		}
}
