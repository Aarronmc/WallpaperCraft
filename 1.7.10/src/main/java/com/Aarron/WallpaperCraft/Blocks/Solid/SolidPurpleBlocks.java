package com.Aarron.WallpaperCraft.Blocks.Solid;
...
public class SolidPurpleBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidPurpleBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidPurple-" + i);
		}
}
