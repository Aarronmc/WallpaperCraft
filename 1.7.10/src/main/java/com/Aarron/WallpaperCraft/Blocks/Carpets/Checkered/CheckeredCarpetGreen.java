...
public class CheckeredCarpetGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredCarpetGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetGreen-" + i);
		}
}
