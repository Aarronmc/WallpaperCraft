...
public class SolidYellowBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidYellowBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidYellow-" + i);
		}
}
