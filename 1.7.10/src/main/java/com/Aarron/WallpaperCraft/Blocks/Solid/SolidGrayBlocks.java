...
public class SolidGrayBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidGrayBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidGray-" + i);
		}
}
