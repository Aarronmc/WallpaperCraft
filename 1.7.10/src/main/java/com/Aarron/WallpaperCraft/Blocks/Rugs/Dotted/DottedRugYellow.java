...
public class DottedRugYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetYellow-" + i);
		}
}
