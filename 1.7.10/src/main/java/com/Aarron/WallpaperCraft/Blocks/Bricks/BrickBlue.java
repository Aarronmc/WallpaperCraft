...
public class BrickBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public BrickBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("BrickBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:BrickBlue-" + i);
		}
}
