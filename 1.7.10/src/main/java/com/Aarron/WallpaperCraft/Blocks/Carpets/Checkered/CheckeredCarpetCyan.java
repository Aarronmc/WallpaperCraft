...
public class CheckeredCarpetCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public CheckeredCarpetCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredCarpetCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:CheckeredCarpetCyan-" + i);
		}
}
