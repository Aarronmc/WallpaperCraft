...
public class DiagonallyDottedRed extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedRed-" + i);
		}
}
