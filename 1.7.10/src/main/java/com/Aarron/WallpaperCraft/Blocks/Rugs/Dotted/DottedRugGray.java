...
public class DottedRugGray extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRugGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRugGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCarpetGray-" + i);
		}
}
