...
public class DottedBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedBrown-" + i);
		}
}
