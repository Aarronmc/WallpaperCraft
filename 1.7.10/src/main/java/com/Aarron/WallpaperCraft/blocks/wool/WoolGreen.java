...
public class WoolGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolGreen-" + i);
		}
}
