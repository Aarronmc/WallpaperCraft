...
public class DamaskCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public DamaskCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskCyan-" + i);
		}
}
