...
public class WoodPlankBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankBrown-" + i);
		}
}
