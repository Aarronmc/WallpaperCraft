...
public class WoolCarpetYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolCarpetYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolCarpetYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolYellow-" + i);
		}
}
