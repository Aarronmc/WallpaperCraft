...
public class WoolCarpetBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolCarpetBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolCarpetBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolBlue-" + i);
		}
}
