...
public class WoolCarpetRed extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolCarpetRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolCarpetRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolRed-" + i);
		}
}
