...
public class DottedGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedGreen-" + i);
		}
}
