...
public class StoneLampGray extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampGray-" + i);
		}
}
