...
public class StoneLampBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampBlue-" + i);
		}
}
