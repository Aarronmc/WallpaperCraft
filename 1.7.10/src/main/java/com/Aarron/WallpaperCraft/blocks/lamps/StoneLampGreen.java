...
public class StoneLampGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampGreen-" + i);
		}
}
