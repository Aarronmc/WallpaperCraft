...
public class DamaskBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskBrown-" + i);
		}
}
