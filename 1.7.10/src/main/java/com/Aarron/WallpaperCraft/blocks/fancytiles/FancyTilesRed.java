...
public class FancyTilesRed extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesRed-" + i);
		}
}
