...
public class AuraLampGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampGreen-" + i);
		}
}
