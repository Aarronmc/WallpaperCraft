...
public class ColouredBrickPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickPurple-" + i);
		}
}
