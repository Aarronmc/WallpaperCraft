...
public class ColouredBrickBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickBlue-" + i);
		}
}
