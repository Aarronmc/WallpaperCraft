...
public class ColouredBrickYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickYellow-" + i);
		}
}
