...
public class WoodPlankBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankBlue-" + i);
		}
}
