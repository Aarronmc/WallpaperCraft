...
public class DottedGray extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedGray-" + i);
		}
}
