...
public class FancyTilesYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesYellow-" + i);
		}
}
