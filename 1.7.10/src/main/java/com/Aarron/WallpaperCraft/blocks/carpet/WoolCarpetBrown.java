...
public class WoolCarpetBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolCarpetBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolCarpetBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolBrown-" + i);
		}
}
