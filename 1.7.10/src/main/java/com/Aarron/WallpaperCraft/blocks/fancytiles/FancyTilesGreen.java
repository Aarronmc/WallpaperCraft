...
public class FancyTilesGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesGreen-" + i);
		}
}
