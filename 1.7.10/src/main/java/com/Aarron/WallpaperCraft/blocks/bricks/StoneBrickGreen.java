...
public class StoneBrickGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickGreen-" + i);
		}
}
