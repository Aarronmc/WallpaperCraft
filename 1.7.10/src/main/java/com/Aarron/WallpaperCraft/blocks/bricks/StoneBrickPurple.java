...
public class StoneBrickPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickPurple-" + i);
		}
}
