...
public class FancyTilesBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesBrown-" + i);
		}
}
