...
public class ColouredBrickGray extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickGray-" + i);
		}
}
