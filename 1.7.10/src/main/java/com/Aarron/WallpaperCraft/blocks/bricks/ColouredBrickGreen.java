...
public class ColouredBrickGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickGreen-" + i);
		}
}
