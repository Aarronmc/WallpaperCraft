...
public class AuraLampGray extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampGray-" + i);
		}
}
