...
public class WoodPlankRed extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankRed-" + i);
		}
}
