...
public class StoneLampBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampBrown-" + i);
		}
}
