...
public class DamaskPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskPurple-" + i);
		}
}
