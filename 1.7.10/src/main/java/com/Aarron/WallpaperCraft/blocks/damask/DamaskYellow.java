package com.Aarron.WallpaperCraft.blocks.damask;
...
public class DamaskYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskYellow-" + i);
		}
}
