...
public class DottedYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedYellow-" + i);
		}
}
