package com.Aarron.WallpaperCraft.blocks.stamp;
...
public class Stamp extends Block {

public IIcon[] icons = new IIcon[16];

	public Stamp(String unlocalizedName, Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 16; i ++) {
			this.icons[i] = reg.registerIcon("wp:Stamp-" + i);
		}
}
