...
public class ColouredBrickRed extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickRed-" + i);
		}
}
