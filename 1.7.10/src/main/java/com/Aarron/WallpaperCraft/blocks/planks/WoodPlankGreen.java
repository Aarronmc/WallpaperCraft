...
public class WoodPlankGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankGreen-" + i);
		}
}
