...
public class DamaskGray extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskGray-" + i);
		}
}
