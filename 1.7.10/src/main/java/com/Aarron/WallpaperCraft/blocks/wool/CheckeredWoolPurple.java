...
public class CheckeredWoolPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredWoolPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredWoolPurple");
