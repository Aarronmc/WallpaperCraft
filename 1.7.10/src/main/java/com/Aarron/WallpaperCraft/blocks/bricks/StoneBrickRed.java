...
public class StoneBrickRed extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickRed-" + i);
		}
}
