...
public class FancyTilesBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesBlue-" + i);
		}
}
