...
public class DamaskGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskGreen-" + i);
		}
}
