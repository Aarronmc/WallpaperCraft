...
public class RippledGreen extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledGreen(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledGreen");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledGreen-" + i);
		}
}
