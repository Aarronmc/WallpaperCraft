...
public class RippledPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledPurple-" + i);
		}
}
