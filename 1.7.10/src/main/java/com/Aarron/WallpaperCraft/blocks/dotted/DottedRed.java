...
public class DottedRed extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedRed-" + i);
		}
}
