...
public class DamaskRed extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskRed-" + i);
		}
}
