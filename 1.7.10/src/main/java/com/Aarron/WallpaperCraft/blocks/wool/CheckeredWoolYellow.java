...
public class CheckeredWoolYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public CheckeredWoolYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("CheckeredWoolYellow");
