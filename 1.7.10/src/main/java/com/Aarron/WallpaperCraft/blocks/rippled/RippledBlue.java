...
public class RippledBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledBlue-" + i);
		}
}
