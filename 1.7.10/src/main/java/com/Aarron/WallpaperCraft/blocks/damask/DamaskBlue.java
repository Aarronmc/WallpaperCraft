...
public class DamaskBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public DamaskBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DamaskBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DamaskBlue-" + i);
		}
}
