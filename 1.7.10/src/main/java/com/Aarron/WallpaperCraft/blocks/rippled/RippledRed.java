...
public class RippledRed extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledRed-" + i);
		}
}
