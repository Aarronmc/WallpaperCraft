...
public class AuraLampRed extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampRed-" + i);
		}
}
