...
public class AuraLampPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampPurple-" + i);
		}
}
