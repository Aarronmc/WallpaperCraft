...
public class AuraLampBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampBrown-" + i);
		}
}
