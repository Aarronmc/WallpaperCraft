...
public class WoodPlankGray extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankGray-" + i);
		}
}
