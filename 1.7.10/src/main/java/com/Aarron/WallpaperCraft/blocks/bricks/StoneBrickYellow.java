...
public class StoneBrickYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickYellow-" + i);
		}
}
