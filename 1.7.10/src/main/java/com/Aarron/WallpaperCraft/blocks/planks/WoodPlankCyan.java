...
public class WoodPlankCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public WoodPlankCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankCyan-" + i);
		}
}
