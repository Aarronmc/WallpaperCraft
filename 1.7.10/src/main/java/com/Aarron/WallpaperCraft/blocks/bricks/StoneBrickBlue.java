...
public class StoneBrickBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickBlue-" + i);
		}
}
