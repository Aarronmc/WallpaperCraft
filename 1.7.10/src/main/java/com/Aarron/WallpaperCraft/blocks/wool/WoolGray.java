...
public class WoolGray extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolGray-" + i);
		}
}
