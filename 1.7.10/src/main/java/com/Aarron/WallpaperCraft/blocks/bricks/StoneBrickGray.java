...
public class StoneBrickGray extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickGray-" + i);
		}
}
