...
public class FloralGray extends Block {

public IIcon[] icons = new IIcon[15];

	public FloralGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralGray-" + i);
		}
}
