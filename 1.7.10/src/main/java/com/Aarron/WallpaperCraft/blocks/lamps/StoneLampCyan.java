...
public class StoneLampCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public StoneLampCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampCyan-" + i);
		}
}
