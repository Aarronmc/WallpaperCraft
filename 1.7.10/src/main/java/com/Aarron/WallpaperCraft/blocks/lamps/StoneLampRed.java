...
public class StoneLampRed extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampRed(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampRed");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampRed-" + i);
		}
}
