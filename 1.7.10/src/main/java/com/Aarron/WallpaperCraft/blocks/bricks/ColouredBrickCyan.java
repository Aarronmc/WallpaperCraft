...
public class ColouredBrickCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public ColouredBrickCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickCyan-" + i);
		}
}
