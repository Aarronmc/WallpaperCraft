...
public class DiagonallyDottedBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedBrown-" + i);
		}
}
