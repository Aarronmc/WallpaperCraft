...
public class DiagonallyDottedPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public DiagonallyDottedPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DiagonallyDottedPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DiagonallyDottedPurple-" + i);
		}
}
