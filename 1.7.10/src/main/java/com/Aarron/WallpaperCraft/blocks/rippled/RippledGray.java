...
public class RippledGray extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledGray-" + i);
		}
}
