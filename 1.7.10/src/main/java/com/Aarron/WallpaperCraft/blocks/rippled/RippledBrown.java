...
public class RippledBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledBrown-" + i);
		}
}
