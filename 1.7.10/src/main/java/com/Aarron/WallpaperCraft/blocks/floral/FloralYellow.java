...
public class FloralYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public FloralYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FloralYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FloralYellow-" + i);
		}
}
