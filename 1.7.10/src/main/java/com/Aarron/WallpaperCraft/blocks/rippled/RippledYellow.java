package com.Aarron.WallpaperCraft.blocks.rippled;
...
public class RippledYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public RippledYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledYellow-" + i);
		}
}
