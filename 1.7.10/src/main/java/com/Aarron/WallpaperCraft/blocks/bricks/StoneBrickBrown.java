...
public class StoneBrickBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneBrickBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneBrickBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneBrickBrown-" + i);
		}
}
