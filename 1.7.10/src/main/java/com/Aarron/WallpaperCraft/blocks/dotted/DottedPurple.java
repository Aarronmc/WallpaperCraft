...
public class DottedPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedPurple-" + i);
		}
}
