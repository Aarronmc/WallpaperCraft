...
public class SolidBlueBlocks extends Block {

public IIcon[] icons = new IIcon[15];

	public SolidBlueBlocks(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("SolidBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:SolidBlue-" + i);
		}
}
