...
public class RippledCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public RippledCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("RippledCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:RippledCyan-" + i);
		}
}
