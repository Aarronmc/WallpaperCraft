...
public class ClayBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public ClayBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ClayBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ClayBlue-" + i);
		}
}
