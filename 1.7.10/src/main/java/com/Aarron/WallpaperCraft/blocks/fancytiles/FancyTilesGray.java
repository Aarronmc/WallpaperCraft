...
public class FancyTilesGray extends Block {

public IIcon[] icons = new IIcon[15];

	public FancyTilesGray(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("FancyTilesGray");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:FancyTilesGray-" + i);
		}
}
