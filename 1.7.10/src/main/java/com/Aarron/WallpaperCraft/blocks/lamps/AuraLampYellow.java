...
public class AuraLampYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public AuraLampYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("AuraLampYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:AuraLampYellow-" + i);
		}
}
