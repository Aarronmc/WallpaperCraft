...
public class StoneLampYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public StoneLampYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("StoneLampYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:StoneLampYellow-" + i);
		}
}
