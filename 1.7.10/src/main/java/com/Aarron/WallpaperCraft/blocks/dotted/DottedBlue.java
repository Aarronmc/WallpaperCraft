...
public class DottedBlue extends Block {

public IIcon[] icons = new IIcon[15];

	public DottedBlue(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedBlue");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedBlue-" + i);
		}
}
