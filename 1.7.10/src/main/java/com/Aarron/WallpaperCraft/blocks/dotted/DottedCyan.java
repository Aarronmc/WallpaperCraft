...
public class DottedCyan extends Block {

public IIcon[] icons = new IIcon[10];

	public DottedCyan(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("DottedCyan");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 10; i ++) {
			this.icons[i] = reg.registerIcon("wp:DottedCyan-" + i);
		}
}
