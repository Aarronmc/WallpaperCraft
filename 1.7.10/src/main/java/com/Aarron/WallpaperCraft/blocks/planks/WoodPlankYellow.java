...
public class WoodPlankYellow extends Block {

public IIcon[] icons = new IIcon[15];

	public WoodPlankYellow(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoodPlankYellow");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoodPlankYellow-" + i);
		}
}
