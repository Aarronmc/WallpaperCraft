...
public class WoolCarpetPurple extends Block {

public IIcon[] icons = new IIcon[15];

	public WoolCarpetPurple(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("WoolCarpetPurple");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:WoolPurple-" + i);
		}
}
