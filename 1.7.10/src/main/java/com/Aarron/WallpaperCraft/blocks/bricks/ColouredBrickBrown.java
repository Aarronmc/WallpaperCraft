...
public class ColouredBrickBrown extends Block {

public IIcon[] icons = new IIcon[15];

	public ColouredBrickBrown(String unlocalizedName, Material material) {
		super(material);
		this.setBlockName("ColouredBrickBrown");
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < 15; i ++) {
			this.icons[i] = reg.registerIcon("wp:ColouredBrickBrown-" + i);
		}
}
